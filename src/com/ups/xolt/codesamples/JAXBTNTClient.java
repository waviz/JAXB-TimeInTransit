...
public class JAXBTNTClient {
    ...
    public static void main( String[] args ) {    
        ...
        try {	    
			...
			System.out.println("Respone as string"+strResults);
    ...
    private static void populateTNTRequest(TimeInTransitRequest tntRequest){   	
		...
		addressFrom.setPoliticalDivision2("san francisco");
		...
		addressTo.setPoliticalDivision2("san francisco");
		addressTo.setPostcodePrimaryLow("94103");
